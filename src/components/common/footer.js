            ...
            <div className='row'>
              <div className='col-md-3 col-sm-6 col-xs-6'>
                <div className='f-box'>
                  ...
                  <ul className='f-menu'>
                    <li>
                      <Link to='/contact-us' onClick={()=>{localStorage.setItem('contact','customer')}}>Customer Care</Link>
                    </li>
                    <li>
                      <Link to='/contact-us' onClick={()=>{localStorage.setItem('contact','producer')}}>Producer/Designer</Link>
                    </li>
                    <li>
                      <Link to='/contact-us' onClick={()=>{localStorage.setItem('contact','career')}}>Career</Link>
                    </li>
                  </ul>
                </div>
              </div>
